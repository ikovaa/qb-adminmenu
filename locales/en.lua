local Translations = {
    ...
    desc = {
        ...
        ["fuel_vehicle_desc"] = "Fuel the vehicle you are in",
    ...
    commands = {
        ...
        ["admin_report"] = "Admin Report",
        ["copy_vector2"] = "Copy vector2 to clipboard (Admin only)",
        ["copy_vector3"] = "Copy vector3 to clipboard (Admin only)",
        ["copy_vector4"] = "Copy vector4 to clipboard (Admin only)",
        ["copy_heading"] = "Copy heading to clipboard (Admin only)",
        ["max_mods"] = "Max mod your current vehicle (Admin Only)",
        ["fuel"] = "Fuel your current vehicle (Admin Only)",
    }
}
Lang = Locale:new({
